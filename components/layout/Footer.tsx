        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/work" className="text-brand-muted hover:text-brand-text transition-colors">
                  Work
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-brand-muted hover:text-brand-text transition-colors">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-brand-muted hover:text-brand-text transition-colors">
                  About
                </Link>
              </li>
              <li>
